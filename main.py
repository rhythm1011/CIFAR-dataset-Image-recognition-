...
def configure():
	...
	#flags.DEFINE_string('modeldir', '/content/drive/My Drive/Colab Notebooks/code/HW3/model_v2', 'model directory')
	### END CODE HERE
...
def main(_):
	...
	model.test_or_validate(x_test, y_test, [100,110,120,130,140,150,160,170,180,190,200])
	### END CODE HERE
